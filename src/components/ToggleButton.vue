<template>
<label :class="className" class="flex flex-row flex-end" :for="computedId" tabindex="0" @keydown.space.prevent="keyToggle" >
  <span class="external-label-left" v-if="externalLabel">{{externalLabel}}</span>
  <div>
    <input
      type="checkbox"
